...
public:
	...
	*/
	bool Equals(const Vector2& rhs, const float delta);
	...
	*/
	Vector2 GetLERP(const Vector2& end, const float percent);

	Vector2 GetQuadBezier(Vector2& mid, Vector2& end, float percent);
	...
	*/
	static Vector2 QuadBezier(const Vector2& a, const Vector2& b, const Vector2& c, float t);

	/**
	Returns a position along Bezier curve calculated from given 4 Vector2 and a given t value.
	*/
	static Vector2 CubicBezier(const Vector2& p0, const Vector2& p1, Vector2& p2, Vector2& p3, float t);

	/**
	Returns a position along Bezier curve calculated from given 3 Vector2 and a given t value.
	*/
	static Vector2 HermiteSpline(const Vector2& point0, const Vector2& point1, const Vector2& tangent0, const Vector2& tangent2, const float t);
...
public:
	...
	*/
	...
	JMATH_API friend bool operator==(const Vector3& lhs, const Vector3& rhs);
...
public:
	...
	*/
	...
	JMATH_API friend  bool operator==(const Vector4& lhs, const Vector4& rhs);
	bool operator!=(const Vector4& rhs);
	JMATH_API friend  bool operator!=(const Vector4& lhs, const Vector4& rhs);
	...
	*/
	...
	JMATH_API friend  std::ostream& operator<<(std::ostream& out, const Vector4& rhs);
...
public:
	...
	*/
	...
	Matrix3 operator-(const Matrix3& rhs);
	Matrix3 operator*(const Matrix3& rhs);
	JMATH_API friend  Vector2 operator*(const Matrix3& lhs, const Vector2& rhs);
	JMATH_API friend  Vector3 operator*(const Matrix3& lhs, const Vector3& rhs);
	...
	JMATH_API friend  bool operator==(const Matrix3& lhs, const Matrix3& rhs);
	JMATH_API friend  bool operator!=(const Matrix3& lhs, const Matrix3& rhs);

	JMATH_API friend  std::ostream& operator<<(std::ostream& out, const Matrix3& m);
...
public:
	...
	*/
	...
	JMATH_API friend  Matrix4 operator+(const Matrix4& lhs, const Matrix4& rhs);
	JMATH_API friend  Matrix4 operator-(const Matrix4& lhs, const Matrix4& rhs);
	JMATH_API friend  Matrix4 operator*(const Matrix4& lhs, const Matrix4& rhs);
	JMATH_API friend  Vector4 operator*(const Matrix4& lhs, const Vector4& rhs);
	...
	JMATH_API friend  bool operator==(const Matrix4& lhs, const Matrix4& rhs);
	JMATH_API friend  bool operator!=(const Matrix4& lhs, const Matrix4& rhs);

	JMATH_API friend  std::ostream& operator<<(std::ostream& out, const Matrix4& m);
